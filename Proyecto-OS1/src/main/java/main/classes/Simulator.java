...
public class Simulator implements Runnable {
    ...
    public Simulator(CPU cpu, PlanningPolicies planningPolicies, CustomQueue<PCB> newQueue, CustomQueue<PCB> readyQueue, CustomQueue<PCB> blockedQueue, CustomQueue<PCB> finishedQueue, CustomQueue<PCB> readySuspendedQueue, CustomQueue<PCB> blockedSuspendedQueue) {
